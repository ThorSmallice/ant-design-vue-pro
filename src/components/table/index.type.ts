...
export interface TableProps extends Omit<ATableProps, 'columns' | 'loading' | 'scroll'> {
	...
	columnsResizable?: TableUseColumnsProps['columnsResizable']
	...
	queryFormOperationBtnsLayout?: TableQueryFormProps['queryFormOperationBtnsLayout']
